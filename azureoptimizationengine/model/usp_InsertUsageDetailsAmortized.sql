...
CREATE OR ALTER PROCEDURE [dbo].[usp_InsertUsageDetailsAmortized]
(
...
BEGIN
	...
	SET NOCOUNT ON
	IF NOT EXISTS(SELECT 1 FROM [dbo].[UsageDetailsAmortized] WHERE Date=@Date and ChargeType = @ChargeType and Cost = @Cost and MeterId = @MeterId and MeterName = @MeterName and ProductId = @ProductId and ResourceId = @ResourceId and UnitPrice = @UnitPrice)
		BEGIN
			INSERT INTO [dbo].[UsageDetailsAmortized] 
