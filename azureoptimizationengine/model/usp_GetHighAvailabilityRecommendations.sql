/****** Object:  StoredProcedure [dbo].[GetHighAvailabilityRecommendations]    Script Date: 2/7/2023 2:19:36 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetHighAvailabilityRecommendations]
    AS BEGIN
        SET NOCOUNT ON;  
        SELECT * FROM [dbo].[Recommendations] R
        WHERE Category = 'HighAvailability' AND GeneratedDate > GETDATE()-365 AND NOT EXISTS (
