/****** Object:  StoredProcedure [dbo].[GetRecommendationsByCategory]    Script Date: 2/7/2023 2:18:15 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetRecommendationsByCategory] @Category nvarchar(50)
    AS BEGIN
        SET NOCOUNT ON;  
        SELECT * FROM [dbo].[Recommendations] R
        WHERE Category = @Category AND GeneratedDate > GETDATE()-365 AND NOT EXISTS (
