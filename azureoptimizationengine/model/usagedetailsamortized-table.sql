...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UsageDetailsAmortized]') AND type in (N'U'))
DROP TABLE [dbo].[UsageDetailsAmortized]
GO
...
CREATE TABLE [dbo].[UsageDetailsAmortized](
 ...
 CONSTRAINT [PK_UsageDetailsAmortized_ID] PRIMARY KEY CLUSTERED 
(
	[PID] ASC
