/****** Object:  StoredProcedure [dbo].[GetSecurityRecommendations]    Script Date: 2/7/2023 2:17:36 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GetSecurityRecommendations]
    AS BEGIN
        SET NOCOUNT ON;  
        SELECT * FROM [dbo].[Recommendations] R
        WHERE Category = 'Security' AND GeneratedDate > GETDATE()-365 AND NOT EXISTS (
